	Ext.define('Asc.common.CdruSelectorPanel',{
		...
		initComponent: function() {
			...
			toSelectStore = new Ext.data.Store({
				...
				sorters : [{
			        sorterFn: function(o1, o2){
			        	var selectedRecs = cdrTree.getSelectionModel().getSelection();
			        	if(selectedRecs.length > 0) {
			        		if(o1.get('key') === selectedRecs[0].get('key')) {
			        			return -1;
			        		} else if(o2.get('key') === selectedRecs[0].get('key')) {
			        			return 1;
			        		}
			        	}
			            type1 = (o1.get('key').slice(0, 1) === 'C') ? 4 :
