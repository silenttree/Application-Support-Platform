...
Ext.onReady(function(){
	...
	editor.on('propertychange', function(source, recordId, value, oldValue){
		editor.record.set(recordId, 'string' == typeof(value) ? value.trim() : value);		
	});
	// 清空编辑窗口
	panel.clearRecord = function(){
		...
		panel.disable();
		editor.suspendEvent('propertychange');
		editor.clearPropertyValues();
		editor.resumeEvent('propertychange');
	};
