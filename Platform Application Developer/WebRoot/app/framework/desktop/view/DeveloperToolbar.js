// 页面下部的页脚区界面
Ext.define('Asc.framework.desktop.view.DeveloperToolbar', {
	
	extend: 'Ext.container.ButtonGroup',
	
	alias: 'widget.AscDesktopDeveloperToolbar',
	...
	items : [/*{
		...
		group : 'sys', name : 'extjsDoc', text : 'ExtJS4Docs', iconCls : 'icon-sys-extjslogo'
	},{
