Ext.define('Asc.framework.Framework', {
	...
	launch : function(){
		...
		// 装载开发工具控制器
		this.loadModule('Asc.framework.designer.controller.Designer', 'AscDesigner');
	},
	// 桌面装载完成
	...
	// 获得开发工具控制器对象
	getAscDesigner : function(){
		return this.getController('AscDesigner');
	},
	// 装载ASC控制器
